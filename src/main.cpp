...
uint256 hashGenesisBlock("0x0c7ae925d4e5ba46a6019840660b2d88c38d360d744654c09a982ec2b07e3505");
...
const string strMessageMagic = "lobbycoin Signed Message:\n";
...
static const int64 nTargetTimespan = 120; // lobbycoin: 2 minute diff readjust
static const int64 nTargetSpacing = 120; // lobbycoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal lobbycoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "lobbycoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xab466db69891b20dfca3a9c9f802e32d554125faddfad820f09520acd30b420e");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Tracy Morgan critically injured in New Jersey crash caused by sleeping truck driver";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1402240015; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1447297;

        if (fTestNet)
        {
            block.nTime    = 1401501366;
            block.nNonce   = 2222224;
        }
        ...
        assert(block.hashMerkleRoot == uint256("caea79999d6746899ab1de8d194256242b478a3af9a0196c2f4ab6068ab1624e"));
